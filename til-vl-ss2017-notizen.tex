...
\begin{document}
    ...
    \begin{description}
        ...
        \item[Satz von Savitch] Speicherbeschränkte NTM können durch DTMs nur mit  quadratischen Mehrkosten simuliert werden. Insbesondere gilt damit $PSpace = NPSpace$.
    \end{description}
