...
\subsubsection*{Aufgabe 1}
    ...
    \begin{enumerate}
        \item $K = \{\ enc(\varphi)\ |\ \varphi\ \text{aussagenlogische\ Formel,\ die\ eine\ erf"ullende\ Belegung\ hat,}$ \\
            ...
            Was ist $\NP$? \hili{$\NP = \{\ L \subseteq \SIGS\ |\ L $ akzeptiert von NTM in polynomieller Zeit $\}$}. \\
...
\newpage
        \item Zeigen SOLITAIRE NP-hart, Reduktion von 3SAT: $\MT{3SAT} \leq_{p} \MT{SOLITAIRE}$.
            ...
            Behauptung: \hili{$\varphi$ erfüllbar $\Leftrightarrow f$ gewinnbar}
...
\newcommand{\SESP}{\MT{SETSPLITTING}}
    ...
    Sei $\varphi = \bigwedge\limits_{i=1}^{k} C_{i}$ eine Formel in KNF. Wir konstruieren in polynomieller Zeit eine Instanz $(S_{\varphi}, \C_{\varphi})$ von SET-SPLITTING so, dass \hili{$\varphi$ erfüllbar $\Leftrightarrow (S_{\varphi}, \C_{\varphi})$ färbbar}.
